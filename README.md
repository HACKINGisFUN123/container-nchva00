...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-nchva00.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-nchva00.containers.anotherwebservice.com/
...
```
git clone git@github.com:HACKINGisFUN123/container-nchva00.git
cd container-nchva00
```
...
```
docker attach container-nchva00
```
